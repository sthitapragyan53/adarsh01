  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/syllabus/12/JEE_ADV`,
    ...
    <div className="dashboard-wrapper">
      ...
      <section className="dashboard-overview glass">
        <div>
          ...
          <p className="overview-subtext">
            Track your JEE Advance preparation subject-wise
          </p>
        </div>
      </section>
      ...
      <section className="dashboard-grid">
        <div className="syllabus-card glass">
          <h2>JEE Advance Syllabus Progress</h2>
          ...
          {subjects.map((subject) => (
            <div
              ...
              onClick={() =>
                navigate(`/exam/jee-Advance/${subject.slug}`)
              }
            >
              <span>
